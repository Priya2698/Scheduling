...
int main(int argc, char *args[]){
    ...
    for(iter=0;iter<runs;iter++) {
        int *recvarr = (int *)malloc(size*D*sizeof(int));
        ...
        MPI_Allgather(arr, D, MPI_INT, recvarr, D, MPI_INT, MPI_COMM_WORLD);
